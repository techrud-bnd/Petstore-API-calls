...
class StoreApi:
    ...
    def delete_order(
        self,
        order_id: Annotated[int, Field(strict=True, ge=1, description="ID of the order that needs to be deleted")],
    ...
    def get_order_by_id(
        self,
        order_id: Annotated[int, Field(le=10, strict=True, ge=1, description="ID of pet that needs to be fetched")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def place_order(
        self,
        body: Annotated[Order, Field(description="order placed for purchasing the pet")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
